const fmtUidv4 = i => i.substr(0, 8) + "-" + i.substr(8, 4) + "-" + i.substr(12, 4) + "-" + i.substr(16, 4) + "-" + i.substr(20)
...
async function getNotionToken() {
    const cookie = await promisif(chrome.cookies.get, {
...
function install_notice() {
    ...
    chrome.tabs.create({url: "https://www.notion.so/Notion-Time-Tracker-Tutorial-972c37bf45e9409baa36e9cf66874a52"});
}
install_notice();